...
const MCQ = {
  ...
  // ── NEW UNITS (added in redesign pass) ──────────────

  "global-ethics": [
    {
      q: "The Belmont Report established which three core principles of research ethics?",
      options: [
        "Consent, confidentiality, and compensation",
        "Respect for persons, beneficence, and justice",
        "Autonomy, honesty, and transparency",
        "Safety, efficacy, and equity"
      ],
      answer: 1
    },
    {
      q: "\"Parachute research\" is criticized because it:",
      options: [
        "Takes too long to complete",
        "Excludes local researchers and communities and leaves little lasting local benefit",
        "Only uses randomized controlled trials",
        "Focuses exclusively on noncommunicable disease"
      ],
      answer: 1
    },
    {
      q: "An Institutional Review Board (IRB) exists primarily to:",
      options: [
        "Approve research budgets",
  ...
  "epi-chronic": [
    {
      q: "Screening for early-stage disease before symptoms appear is an example of:",
      options: [
        "Primary prevention",
    ...
    {
      q: "A long latency period between exposure and disease makes it harder to:",
      options: [
        "Treat the disease once diagnosed",
        "Establish a clear causal link between the exposure and the disease",
        "Vaccinate against the disease",
        "Calculate the disease's case fatality rate"
      ],
      answer: 1
    },
    {
      q: "Most chronic diseases, such as type 2 diabetes, are best described as having:",
      options: [
        "A single genetic cause",
        "Multifactorial etiology involving genetic, environmental, and behavioral factors",
        "No known risk factors",
        "Only infectious causes"
      ],
      answer: 1
    }
  ],
  "climate-health": [
    {
      q: "Climate mitigation differs from climate adaptation because it:",
      options: [
        "Responds to climate impacts already occurring",
        "Aims to reduce or prevent greenhouse gas emissions at the source",
        "Only applies to coastal cities",
        "Is unrelated to public health"
      ],
      answer: 1
    },
    {
      q: "Urban heat islands are primarily caused by:",
      options: [
        "High elevation",
        "Human infrastructure such as pavement and buildings that absorb and retain heat",
    ...
    {
      q: "Climate change is expected to affect vector-borne disease patterns by:",
      options: [
        "Eliminating disease vectors entirely",
        "Shifting the geographic range and seasonality of disease vectors",
        "Having no measurable effect",
        "Only affecting waterborne, not vector-borne, disease"
      ],
      answer: 1
    }
  ],
  "survival-analysis": [
    {
      q: "Censoring in survival analysis refers to:",
      options: [
        "Removing outliers from a data set",
        "Not knowing a subject's exact event time, often because the study ended first",
        "A type of measurement bias",
        "A method for randomizing participants"
      ],
      answer: 1
    },
    {
      q: "A Kaplan-Meier curve is used to visualize:",
      options: [
        "The relationship between two continuous variables",
        "The estimated probability of survival over time",
    ...
    {
      q: "The Cox proportional hazards model is used to:",
      options: [
        "Estimate the effect of predictors on the hazard of an event without assuming a specific shape for the hazard over time",
        "Calculate a simple correlation coefficient",
        "Replace the need for a control group",
        "Measure sensitivity and specificity of a diagnostic test"
      ],
      answer: 0
    }
  ],
